...
def login():
	...
	elementUserNameTextBox.send_keys('07021518523')
	time.sleep(1)
	driver.find_element(By.NAME,passTextBoxName).send_keys('Syota8523')
	time.sleep(1)

#	loginButtonClassName = '//*[@id="loginForm"]/div/div[3]/button'
	elementLoginButton = driver.find_element(by=By.XPATH, value='//*[@id="loginForm"]/div/div[3]/button')
